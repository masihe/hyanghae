"""오타 검문소의 보호 목록을 만든다. 사전 v1.18 기준.

    ./venv/Scripts/python.exe -W ignore 86_protected_words_v1_18.py
...
LEXICON = pathlib.Path("data/scent_knowledge/domain_lexicon_v1_18.csv")
OUT = pathlib.Path("data/scent_knowledge/protected_words_v1_18.txt")
