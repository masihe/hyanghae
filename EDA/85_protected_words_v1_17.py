"""오타 검문소의 보호 목록을 만든다. 사전 v1.17 기준.

    ./venv/Scripts/python.exe -W ignore 85_protected_words_v1_17.py
...
LEXICON = pathlib.Path("data/scent_knowledge/domain_lexicon_v1_17.csv")
OUT = pathlib.Path("data/scent_knowledge/protected_words_v1_17.txt")
